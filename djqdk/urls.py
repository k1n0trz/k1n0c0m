...
urlpatterns = [
    ...
    path('servicios/desarrollo/', views.desarrollo, name='desarrollo'),
    path('servicios/marketing/', views.marketing, name='marketing'),
    path('servicios/produccion/', views.produccion, name='produccion'),
    path('servicios/eventos/', views.eventos, name='eventos'),
